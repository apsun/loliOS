...
#define VGA_FONT_PAGE_START 0x000A0000UL
#define VGA_FONT_PAGE_END   0x000B0000UL

#define VGA_TEXT_PAGE_START 0x000B8000UL
#define VGA_TEXT_PAGE_END   0x000B9000UL

#define VIDMAP_PAGE_START   0x000B9000UL
#define VIDMAP_PAGE_END     0x000BA000UL

#define KERNEL_PAGE_START   0x00400000UL
#define KERNEL_PAGE_END     0x00800000UL

#define KERNEL_HEAP_START   0x00800000UL
#define KERNEL_HEAP_END     0x07C00000UL

#define TEMP_PAGE_START     0x07C00000UL
#define TEMP_PAGE_END       0x08000000UL

#define USER_PAGE_START     0x08000000UL
#define USER_PAGE_END       0x08400000UL

#define USER_HEAP_START     0x08400000UL
#define USER_HEAP_END       0x10000000UL

#define VGA_VBE_PAGE_START  0xE0000000UL
#define VGA_VBE_PAGE_END    0xE0800000UL
