...
__attribute__((cdecl)) int sigaction(int signum, void (*handler)(int signum));
...
__attribute__((cdecl)) int ioctl(int fd, int req, int arg);
...
__attribute__((cdecl)) int fcntl(int fd, int req, int arg);
